...
## Project Structure
    ...
    ├── testapiautoconnecto_85182  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_85182`
...
2. Clone this repo and `cd testapiautoconnecto_85182`
